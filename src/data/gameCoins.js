...
export const gameCoinsCatalog = [
  // ─── HoYoverse ───────────────────────────────────────────────
  {
    ...
    currencyIcon: '/images/icons/genshin-crystals.png',
    image: '/images/icons/genshin-pack.png',
    coverImage: '/images/icons/genshin-pack.png',
    color: '#a78bfa',
    packs: [
  ...
  },
  {
    ...
    currencyIcon: '/images/icons/honkai-shards.png',
    image: '/images/icons/honkai-star-rail.png',
    coverImage: '/images/icons/honkai-star-rail.png',
    color: '#38bdf8',
    packs: [
  ...
  },
  {
    ...
    company: 'HoYoverse',
    currency: 'Monochrome',
    currencyIcon: '/images/icons/zenless-monochrome.png',
    image: '/images/icons/zenless-zone-zero.png',
    coverImage: '/images/icons/zenless-zone-zero.png',
    color: '#f97316',
    packs: [
  ...
  // ─── Riot Games ──────────────────────────────────────────────
  {
    ...
    currencyIcon: '/images/icons/lol-rp.png',
    image: '/images/icons/league-of-legends.png',
    coverImage: '/images/icons/league-of-legends.png',
    color: '#c89b3c',
    packs: [
  ...
  },
  {
    ...
    currencyIcon: '/images/icons/valorant-vp.png',
    image: '/images/icons/valorant-icon.png',
    coverImage: '/images/icons/valorant-icon.png',
    color: '#ff4655',
    packs: [
  ...
  // ─── Otros ───────────────────────────────────────────────────
  {
    ...
    image: '/images/icons/fortnite.png',
    coverImage: '/images/icons/fortnite.png',
    color: '#60a5fa',
    packs: [
  ...
  },
  {
    ...
    coverImage: '/images/icons/minecraft.png',
    color: '#4ade80',
    packs: [
